...
Studio Taglialatela · Ultima modifica: 17/08/2026 · Dipendenze: nessuna · Rilievi R14, R27, R28, R29
...
**Il nome esatto si consegna insieme al file** *(R29, 17/08/2026)*
La scheda del file allegato in conversazione mostra il nome **con lo spazio al
posto dell'underscore**, e il download lo salva così: chi carica su GitHub
riproduce lo spazio senza accorgersene, e il router va in 404 alla sessione
dopo. Ogni consegna destinata al repository porta quindi, scritto in chiaro
accanto al file, **il nome esatto da digitare** e la cartella di destinazione.
